      ...
      <div id="plant" class="section  product">
		...
		<div class="formbold-main-wrapper">
			...
			<div class="formbold-form-wrapper">
			  <form action="authorCreateAction.php" method="POST" enctype="multipart/form-data">
					<div class="formbold-input-flex">
						<input type="hidden" name="idauthor" id="idauthor" value="<?=$id?>"/>
					  <div>
							<input type="text" name="namaauthor" id="namaauthor" class="formbold-form-input"/>
							<label for="namaauthor" class="formbold-form-label"> Nama Author </label>
					  </div>
					  <div>
							<input type="text" name="deskripsiauthor" id="deskripsiauthor" class="formbold-form-input"/>
