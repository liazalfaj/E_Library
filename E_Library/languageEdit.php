      ...
      <div id="plant" class="section  product">
		...
		<div class="formbold-main-wrapper">
			...
			<div class="formbold-form-wrapper">
			  <form action="languageEditAction.php" method="POST" enctype="multipart/form-data">
					<div class="formbold-input-flex">
						<input type="hidden" name="idbahasa" id="idbahasa" value="<?=$id?>"/>
					  <div>
							<input type="text" name="namabahasa" id="namabahasa" class="formbold-form-input" value="<?=$lang['language_name']?>"/>
