      ...
      <div id="plant" class="section  product">
		...
		<div class="formbold-main-wrapper">
			...
			<div class="formbold-form-wrapper">
			  <form action="genreEditAction.php" method="POST" enctype="multipart/form-data">
					<div class="formbold-input-flex">
						<input type="hidden" name="idgenre" id="idgenre" value="<?=$id?>"/>
					  <div>
							<input type="text" name="namagenre" id="namagenre" class="formbold-form-input" value="<?=$genre['genre_name']?>"/>
							<label for="namagenre" class="formbold-form-label"> Nama Genre </label>
					  </div>
					</div>
