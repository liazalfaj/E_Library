      ...
      <div id="plant" class="section  product">
		...
		<div class="formbold-main-wrapper">
			...
			<div class="formbold-form-wrapper">
			  <form action="bookCreateAction.php" method="POST" enctype="multipart/form-data">
					<div class="formbold-input-flex">
					  <div>
							<input type="text" name="judulbuku" id="judulbuku" class="formbold-form-input"/>
							<label for="judulbuku" class="formbold-form-label"> Nama Buku </label>
					  </div>
					  <div>
							<select id="author" name ="author" style="width: 100%" hidden>
							<?php
                				foreach ($author as $thor){
                    			echo "<option value=$thor[author_id]>" . $thor['author_name'] . "</option>";
                				}            
            				?>
							</select>
							<label for="author" class="formbold-form-label"> Penulis (jika tidak ada <a href="authorCreate.php">klik disini</a>)</label>
					  </div>
					</div>
					<div class="formbold-input-flex">
					  <div>
							...
							<label for="genre" class="formbold-form-label"> Genre (jika tidak ada <a href="genreCreate.php">klik disini</a>)</label>
					  </div>
					  <div>
					  <select id="bahasa" name ="bahasa" style="width: 100%" hidden>
							<?php
                				foreach ($bahasa as $bah){
                    			echo "<option value=$bah[language_id]>" . $bah['language_name'] . "</option>";
                				}            
            				?>
							</select>
							<label for="bahasa" class="formbold-form-label"> Bahasa (jika tidak ada <a href="languageCreate.php">klik disini</a>)</label>
					  </div>
					</div>
		 
					<div class="formbold-textarea">
						 <input type = "text" name="tahunterbit" id="tahunterbit" class="formbold-form-input" >
						 <label for="tahunterbit" class="formbold-form-label"> Tahun terbit </label>
					</div>
					
					<br>
					<div class="formbold-textarea">
						<textarea rows="6" name="deskripsi" id="deskripsi" class="formbold-form-input"></textarea>
