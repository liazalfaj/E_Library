      ...
      <div id="plant" class="section  product">
            ...
            <div class="row">
               <div class="col-md-12 ">
                  <div class="titlepage" style="padding: 0px 0px 10px;">
                     <center><h2><strong class="black"> Form</strong>  Bahasa</h2></center>
                  </div>
               </div>
            </div>
         </div>
		...
		<div class="formbold-main-wrapper">
			...
			<div class="formbold-form-wrapper">
			  <form action="languageCreateAction.php" method="POST" enctype="multipart/form-data">
					<div class="formbold-input-flex">
						<input type="hidden" name="idbahasa" id="idbahasa" value="<?=$id?>"/>
					  <div>
							<input type="text" name="namabahasa" id="namabahasa" class="formbold-form-input"/>
							<label for="namabahasa" class="formbold-form-label"> Nama Bahasa </label>
					  </div>
					</div>
